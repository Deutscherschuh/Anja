...
module.exports = {
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://<db_username>:<db_password>@cluster0.8bfpc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "eWx4Mmo_Queen-Anya_2eXA=",
